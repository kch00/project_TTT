...
public class EmployeeTodoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_employee_todo, container, false);
    ...
    private void addTodoItem() {
        ...
        if (!text.isEmpty()) {
            ...
            if (result != -1) {
                ...
                etTodoText.setText("");
                Toast.makeText(getContext(), "할일 항목이 추가되었습니다.", Toast.LENGTH_SHORT);
            } else {
                Toast.makeText(getContext(), "할일 항목 추가에 실패했습니다.", Toast.LENGTH_SHORT);
            }
        }
    }
        ...
        textView.setOnLongClickListener(new View.OnLongClickListener() { // 길게 누르면 삭제
            ...
            public boolean onLongClick(View v) {
                ...
                if (databaseHelper.deleteTodoItem(id)) {
                    ...
                    Toast.makeText(getContext(), "할일 항목이 삭제되었습니다.", Toast.LENGTH_SHORT);
                } else {
                    Toast.makeText(getContext(), "할일 항목 삭제에 실패했습니다.", Toast.LENGTH_SHORT);
                }
                return true;
            }
        });
